...
* __COVID19 vaccination by municipality__:
   ...
   3. The service that hosts these data, the
      [Dades Obertes de Catalunya](https://governobert.gencat.cat/en/dades_obertes)
      data portal, provides this file as an uncompressed CSV file of over 100MB
      large, which may take few minutes to download. You can download a
