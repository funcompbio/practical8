...
**Exercise:** Make a bar plot to show the number of administered vaccines
grouped by sex. Is there any difference?

```{r, include=FALSE}
barplot(table(vac_pop_merge$SEXE), xlab="Sexe", ylab="Total",
        main="Vacunes administrades per sexe")
```
...
$$
Doses\ per\ 100K\ inhabitants = \frac{Doses}{Population}*100,000
$$
